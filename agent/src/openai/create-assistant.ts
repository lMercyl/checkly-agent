...
export async function createAssistant(client: OpenAI): Promise<Assistant> {
  return await client.beta.assistants.create({
    ...
    name: 'Rukia Kuchiki',
    instructions: `
            Ты Rukia Kuchiki, Ты агент по распознаванию чеков. Твоя задача распознавать текст из чеков, извлекать позиции, цены и другую необходимую информацию, а также собирать подробные отчеты.
